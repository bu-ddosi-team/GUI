...
namespace SeniorDesign_1 {
	...
	public: 
		...
		Form1(void)
		{
			...
			xmlDoc.LoadFile("C:\\Users\\ddosi\\Desktop\\ProfileName.xml");
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->stepsPerSweepUpDown->Maximum = System::Decimal(gcnew cli::array< System::Int32 >(4) {400, 0, 0, 0});
...
private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
			...
			// string SamPS(samplesPerStep);
			 ...
			 {
				DsauClient::sendThis(LDP.append("1")); //Simultaneous = 1
			 }
			 else
			 {
				 DsauClient::sendThis(LDP.append("2")); //Sequential = 2
			 }
